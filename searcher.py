    ...
    def searchByStructure(self, rawQueryStructures):
        ...
        with open(self.structureIndexPath) as indexFile:
            ...
            for line in reader:
                ...
                distance = self.solveStructureDistance(structures,
                                                       queryStructures)
                searchResults[line[0]] = distance
            indexFile.close()
        return searchResults

    def search(self, color_features, structure_features, limit=3):
        featureResults = self.searchByColor(color_features)
        structureResults = self.searchByStructure(structure_features)
        results = {}
